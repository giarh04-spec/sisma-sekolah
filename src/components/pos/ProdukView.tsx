...
import { Search, Plus, Edit3, Trash2, Barcode, Printer, Download, Upload, Image as ImageIcon } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="bg-[#18181b] border border-slate-800 rounded-2xl w-full max-w-xl overflow-hidden shadow-2xl flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              <div className="space-y-1">
                <label className="text-xs font-semibold text-slate-400">URL Foto Produk</label>
                <input
                  type="text"
